...
@REM   i.e.   ${workspace_loc:SDCardDemo}/make_launcher.bat
...
@set ERIKA_FILES=C:\EmbeddedSystems\Software\EE_RTwin32-x86_64\eclipse\plugins\com.eu.evidence.ee_2.6.0.20151106_2005\ee_files
