...
uint8_t IOE_Config(void)
{
  ...
  uint8_t rest=IOE_FnctCmd(IOE_1_ADDR, IOE_IO_FCT | IOE_TS_FCT | IOE_ADC_FCT, ENABLE);
...
static void IOE_GPIO_Config(void)
{
  ...
  //RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C1 |RCC_APB1Periph_I2C2 | RCC_APB1Periph_SPI3, ENABLE);
